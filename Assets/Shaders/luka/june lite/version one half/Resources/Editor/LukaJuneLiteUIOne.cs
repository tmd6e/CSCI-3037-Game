...
public class LukaJuneLiteUIOneHalf : ShaderGUI
{
    ...
    private static string strVersion = "1.5";
    ...
    string strUiAdviceForNewPpl = 
        ...
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Do not</b> animate module toggles. Modules determine which code are included in the final shader build to provide the highest amount of optimization, and animating the module toggles would result in multiple shader copies being created and used!\n\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Do not</b> animate speeds (like on distortion or shake) – it will look choppy. Instead, animate the power options.\n\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Use a <b>cube</b> for the shader and material, not a sphere, plane, or particle system. While you be able to achieve the same look with a sphere, think about how many vertices are in one compared to a simple cube?\n\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Utilize <b>fall-off</b> (under rendering). Please. Nobody likes global effects.\n\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Make sure to <b>remove the box (or mesh) collider</b> from the cube (or mesh) you are using for the shader.\n\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Do not</b> use the shader to annoy, harm, or in anyway disrupt other users' gameplay.\n\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Do not</b> use multiple copies of the shader at once.\n\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Keep in mind: the more modules and effects you use, the <b>more performance will be impacted</b>.\n\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Buy the pro version of June!</b>\n";
    string strUiLicense = 
        ...
        LukaJuneLiteOneHalfLibrary.getHeart() + " You <b>may not</b> redistribute this shader in its purest form (ex. the code or packages alone) on any platform such as chatting apps (ex: Discord, Skype), storage hosts (ex: VPS servers, Dropbox, Google Drive), websites dedicated to VRChat or Unity content, or through any other means.\n\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " You <b>may not</b> edit the code to the shader or any related files.\n\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " You <b>may not</b> use this work to promote hate or harm in any way (ex: seizure-inducing animations, offensive overlays)\n\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " You <b>may</b> include this in transformative works (ex: animations, avatars, worlds, and games). You may bundle the file alongside it if you want, or have the user download it from a respective source I host (ex: Gumroad) if you wish.\n\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " You <b>may</b> include this in transformative works that are either public (free) or private (commercial). Either is ok! I would appreciate if you consider donating to me if you use it to make lots of money, but it isn't required <3\n\n" +
    ...
    string strUiAboutMe = 
        ...
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Discord:</b> luka#8375\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Website:</b> luka.moe\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>GitHub:</b> github.com/lukasong\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>YouTube:</b> https://www.youtube.com/channel/UCwyJeuxwhgnxre3FaSacEuga\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Gumroad:</b> https://lukasong.gumroad.com\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Booth:</b> https://lukasong.booth.pm\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Email:</b> lukazoeysong@gmail.com";
    string strUiWherePro = 
        ...
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Gumroad: </b> 55 USD, 50 Euros, 6000 JPY. Get it at lukasong.gumroad.com!\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Booth: </b> 55 USD, 50 Euros, 6000 JPY. Get it at lukasong.booth.pm!\n" + 
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Discord (Paypal, CashApp, Bitcoin, Monero): </b> 45 USD for Paypal, 55 USD for other methods. Add me: luka#8375 !\n\n" + 
    ...
    string strUiProVsCompetitor = 
        ...
        LukaJuneLiteOneHalfLibrary.getHeart() +  " <b>June is unique and customizable.</b> " + LukaJuneLiteOneHalfLibrary.getHeart() + "\n" +
        ...
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>June is faster than the rest.</b> " + LukaJuneLiteOneHalfLibrary.getHeart() + "\n" +
        ...
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>No shaders</b> ran at an average of 65 FPS.\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>June</b> ran at an average of 63 FPS. <i>(with a medium-quality blur)</i>\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Akai's Cancerspace</b> ran at an average of 60 FPS. <i>(with an ultra-low-quality blur, the highest offered)</i>\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Mochie's SFX</b> ran at an average of 61 FPS. <i>(with a slightly-under-medium-quality blur)</i>\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Doppelganger's Dope</b> ran at an average of 61 FPS. <i>(with a medium-quality blur)</i>\n\n" +
        ...
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>June is original.</b> " + LukaJuneLiteOneHalfLibrary.getHeart() + "\n" +
        ...
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>June is updated.</b> " + LukaJuneLiteOneHalfLibrary.getHeart() + "\n" +
        ...
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>June is also a Unity tool-box.</b> " + LukaJuneLiteOneHalfLibrary.getHeart() + "\n" +
        ...
        LukaJuneLiteOneHalfLibrary.getHeart() + " 10+ themes and 10+ languages!\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " 30+ presets!\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Audio waveform preview generator!\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Surfknasen's music auto-animation (his idea and permission to include <3)!\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " My Necromancer script! Test your avatar in Unity with animations, movement, and physics, control and automate your camera, and generate poses as .anim files with your keyboard easily!\n\n" +
    ...
    string strUiWhatIsPro = "June originally started out as a private-only shared called MAE. After taking a break for a year, in 2021 I returned to VRChat and Unity development and made June - the sequel to it (free for MAE buyers of course, I keep my word) that was a completely new shader with the same spirit. \n\nAs of now, it's been out for months as a paid shader, but I decided to make a \"lite\" version for a few reasons..\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " It is a good introduction for new users. June (pro) itself has so much stuff, a simpler shader like this can help get mew users familiar with post-processing shaders!\n " +
        LukaJuneLiteOneHalfLibrary.getHeart() + " It lets users \'trial\' and see my work before buying June Pro, even if it just a little glimpse.\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " It lets creators and animators have a re-distributable package to make their work with!\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " It helps out those who cannot afford June Pro, I have been there and understand it frens :3\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " It's free advertisement! Duh\n\n" +
    ...
    string strUiProVsLite = 
        ...
        LukaJuneLiteOneHalfLibrary.getHeart() + " Pro has 20x the options that Lite has.\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Pro has 5x the effects that Lite has.\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Pro has multiple scripts for Unity that Lite doesn't.\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Pro has support for over 10 languages and has over 10 themes.\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Pro has over 30 presets to get you started.\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Pro has unique effects not in any other shader but Pro.\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Pro has a less cluttured UI with no \"ads\" (sowwy but hey this is free!!).\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Pro has more render settings, including testing values such as depth and stencil buffers!\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Pro has more modules.\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Pro gets more updates.\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Pro has more quality variations.\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " Pro has easy-to-use buttons in the Unity menu that automatically set up materials and shader instances for you!.\n";
    string strUiProFeatures = 
        "While not complete, I hope this can help you learn more about my \"little\" project.\n\n" +
        LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Modules</b> " + LukaJuneLiteOneHalfLibrary.getHeart() + "\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Rendering - 4 sections\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Shader - 3 sections\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Blur - 19 styles\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Chromatic Aberration - 6 styles\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Color Manipulation - 18 sections\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Border - 6 styles\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Creativity - 15 sections\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Distortion - 9 sections\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Enhancements - 6   sections\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Filters - 37 sections\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Frames - 11 styles\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Generation - 8 sections\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Glitch - 3 sections\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Motion - 10 sections\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Outlines - 10+ styles\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Overlay - 3 sections\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Stylize - 16 sections\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Special - 12 sections\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Transition - 10 styles\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Triplanar - 4 styles\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " UV Manipulation - 26 sections\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Vertex Reconstruction - 6 sections\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Zoom - 10 styles\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " And more on-going!\n\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " <b>Unity Features</b> " + LukaJuneLiteOneHalfLibrary.getHeart() + "\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Auto-generate shader instances for you in the scene!\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Auto-generate shader layers with render queues for you in the scene!\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Test your avatars in Unity with avatar controllers, camera controllers, and posing!\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " Auto-animate to the beat of the music with scripts!\n" +
         LukaJuneLiteOneHalfLibrary.getHeart() + " 30+ presets in the UI and make your own!\n\n" +
    ...
    private static void loadStyles() {
        styHeader = LukaJuneLiteOneHalfLibrary.makeStyle(18, TextAnchor.MiddleCenter);
        stySubHeader = LukaJuneLiteOneHalfLibrary.makeStyle(12, TextAnchor.MiddleCenter);
        styFooter = LukaJuneLiteOneHalfLibrary.makeStyle(10, TextAnchor.MiddleCenter);
        styJuneHeader = LukaJuneLiteOneHalfLibrary.makeStyle(14, TextAnchor.MiddleCenter);
        styJuneSubHeader = LukaJuneLiteOneHalfLibrary.makeStyle(10, TextAnchor.MiddleCenter);
        styDescription = LukaJuneLiteOneHalfLibrary.makeStyle(12, TextAnchor.MiddleLeft);
    }
    ...
    private static void loadMeta() {
        string strMetaRaw = LukaJuneLiteOneHalfLibrary.getServerContents("https://www.luka.moe/call/public/JuneLiteOneHalf/JuneMeta.moe");
        int intIndex = 0;
    ...
    public override void OnGUI(MaterialEditor meThis, MaterialProperty[] propertiesThis)
    {
        ...
        // header
        LukaJuneLiteOneHalfLibrary.makeBanner("Images/JuneLiteBanner_ForLukaSong_ByAtArotxt_OnTwitter");

        // presented by
        EditorGUILayout.Space();
        LukaJuneLiteOneHalfLibrary.makeText("june presented by luka#8375", styHeader);
        // too busy.. LukaJuneLiteOneHalfLibrary.makeText("a post-processing suite and unity toolbox", stySubHeader);
        LukaJuneLiteOneHalfLibrary.makeText("you are using the <b>free, public, and trial version</b>", stySubHeader);
        LukaJuneLiteOneHalfLibrary.makeText("www.luka.moe " + LukaJuneLiteOneHalfLibrary.getHeart() + " github.com/lukasong " + LukaJuneLiteOneHalfLibrary.getHeart() + " luka#8375", stySubHeader);
        LukaJuneLiteOneHalfLibrary.makeText(LukaJuneLiteOneHalfLibrary.getHeart() + " artwork provided by @lumiechuu " + LukaJuneLiteOneHalfLibrary.getHeart(), stySubHeader);
        LukaJuneLiteOneHalfLibrary.makeText("<b>redistribution restricted.</b> please see the license!", stySubHeader);

        // lite update
        LukaJuneLiteOneHalfLibrary.doNotifcation(boolUiMetaLiteUpdate, strUiMetaLiteUpdateTitle, strUiMetaLiteUpdateDescription, 12); 
        LukaJuneLiteOneHalfLibrary.doNotifcation(boolUiMetaProUpdate, strUiMetaProUpdateTitle, strUiMetaProUpdateDescription, 12);
        LukaJuneLiteOneHalfLibrary.doNotifcation(boolUiMetaOtherAnnouncement, strUiMetaOtherAnnouncementTitle, strUiMetaOtherAnnouncementDescription, 12);

        // displaying the gui..
        LukaJuneLiteOneHalfLibrary.makeDivider();
        ...
        // rendering tab
        tabRendering = LukaJuneLiteOneHalfLibrary.makeFoldout(tabRendering, "Rendering", 16);
        if (tabRendering)
        {
            EditorGUILayout.Space();
        ...
        // blur tab
        tabBlur = LukaJuneLiteOneHalfLibrary.makeFoldout(tabBlur, "Blur" + toggleBlur, 16);
        if (tabBlur)
        {
            EditorGUILayout.Space();
            prpLiteBlurModule = ShaderGUI.FindProperty("_LiteBlurModule", propertiesThis);
        ...
        // border tab
        tabBorder = LukaJuneLiteOneHalfLibrary.makeFoldout(tabBorder, "Border" + toggleBorder, 16);
        if (tabBorder)
        {
            EditorGUILayout.Space();
            prpLiteBorderModule = ShaderGUI.FindProperty("_LiteBorderModule", propertiesThis);
        ...
        // coloring tab
        tabColoring = LukaJuneLiteOneHalfLibrary.makeFoldout(tabColoring, "Coloring" + toggleColoring, 16);
        if (tabColoring)
        {
            EditorGUILayout.Space();
            prpLiteColoringModule = ShaderGUI.FindProperty("_LiteColoringModule", propertiesThis);
        ...
        // distortion tab
        tabDistortion = LukaJuneLiteOneHalfLibrary.makeFoldout(tabDistortion, "Distortion" + toggleDistortion, 16);
        if (tabDistortion)
        {
            prpLiteDistortionModule = ShaderGUI.FindProperty("_LiteDistortionModule", propertiesThis);
        ...
        // filter tab
        tabFilter = LukaJuneLiteOneHalfLibrary.makeFoldout(tabFilter, "Filters" + toggleFilters, 16);
        if (tabFilter)
        {
            EditorGUILayout.Space();
            prpLiteFilterModule = ShaderGUI.FindProperty("_LiteFilterModule", propertiesThis);
            meThis.ShaderProperty(prpLiteFilterModule, "Enable Filter Module");
            LukaJuneLiteOneHalfLibrary.doFoldoutIndentStart(20);
            tabSubFilterVignette = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubFilterVignette, "Vignette");
            ...
            tabSubFilterColorCrush = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubFilterColorCrush, "Color Crush");
            ...
            tabSubFilterDuotone = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubFilterDuotone, "Duotone");
            ...
            tabSubFilterRainbow = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubFilterRainbow, "Rainbow");
            ...
            tabSubFilterFilm = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubFilterFilm, "Film");
            if (tabSubFilterFilm) {
            ...
            tabSubFilterGrain = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubFilterGrain, "Grain");
            ...
            tabSubFilterVHS = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubFilterVHS, "VHS");
            if (tabSubFilterVHS) {
            ...
            tabSubFilterGradient = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubFilterGradient, "Gradient");
            ...
            tabSubFilterOutline = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubFilterOutline, "Outline");
            ...
            tabSubFilterGlitch = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubFilterGlitch, "Glitch");
            ...
            tabSubFilterAstral = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubFilterAstral, "Astral");
            ...
            tabSubFilterNeon = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubFilterNeon, "Neon");
            if (tabSubFilterNeon) {
            ...
            LukaJuneLiteOneHalfLibrary.doFoldoutIndentEnd();
            EditorGUILayout.Space();
        }
        
        // overlay tab
        tabOverlay = LukaJuneLiteOneHalfLibrary.makeFoldout(tabOverlay, "Overlay" + toggleOverlay, 16);
        if (tabOverlay)
        {
            EditorGUILayout.Space();
            prpLiteOverlayModule = ShaderGUI.FindProperty("_LiteOverlayModule", propertiesThis);
        ...
        // uv manipulation tab
        tabUVManipulation = LukaJuneLiteOneHalfLibrary.makeFoldout(tabUVManipulation, "UV Manipulation" + toggleUVManipulation, 16);
        if (tabUVManipulation)
        {
            ...
            LukaJuneLiteOneHalfLibrary.doFoldoutIndentStart(20);
            tabSubUVTransformation = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubUVTransformation, "Transformation");
            ...
            tabSubUVMove = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubUVMove, "Movement");
            if (tabSubUVMove)
            {
            ...
            tabSubUVShake = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubUVShake, "Shake");
            if (tabSubUVShake)
            {
            ...
            tabSubUVPixelation = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubUVPixelation, "Pixelation");
            ...
            tabSubUVRotation = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubUVRotation, "Rotation");
            if (tabSubUVRotation)
            {
            ...
            tabSubUVSpherize = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubUVSpherize, "Spherize");
            if (tabSubUVSpherize)
            {
            ...
            tabSubUVGlitch = LukaJuneLiteOneHalfLibrary.makeFoldoutSub(tabSubUVGlitch, "UV Glitch");
            if (tabSubUVGlitch)
            {
        ...
        // zoom tab
        tabZoom = LukaJuneLiteOneHalfLibrary.makeFoldout(tabZoom, "Zoom" + toggleZoom, 16);
        if (tabZoom)
        {
            EditorGUILayout.Space();
            prpLiteZoomModule = ShaderGUI.FindProperty("_LiteZoomModule", propertiesThis);
        ...
        // june discount
        LukaJuneLiteOneHalfLibrary.doNotifcation(boolUiMetaProDiscount, strUiMetaProDiscountTitle, strUiMetaProDiscountDescription, 12);

        LukaJuneLiteOneHalfLibrary.makeDivider();

        // settings tab
        tabExtraSettings = LukaJuneLiteOneHalfLibrary.makeFoldout(tabExtraSettings, "Settings", 16);
        if (tabExtraSettings) {
            EditorGUILayout.BeginVertical("GroupBox");
            LukaJuneLiteOneHalfLibrary.doGreyStart();
            ...
            LukaJuneLiteOneHalfLibrary.doGreyEnd();
            LukaJuneLiteOneHalfLibrary.drawToastNoImage(strUiLockTheme, 12, 200);
        ...
        // licesense tab 
        tabExtraLicense = LukaJuneLiteOneHalfLibrary.makeFoldout(tabExtraLicense, "<b>Shader License</b> (must read)", 16);
        if (tabExtraLicense) {
            EditorGUILayout.BeginVertical("GroupBox");
            LukaJuneLiteOneHalfLibrary.makeText(strUiLicense, styDescription);
            EditorGUILayout.EndVertical();
            EditorGUILayout.Space();
        }

        // advice me tab
        tabExtraAdvice = LukaJuneLiteOneHalfLibrary.makeFoldout(tabExtraAdvice, "Advice for New Users", 16);
        if (tabExtraAdvice)
        {
            EditorGUILayout.BeginVertical("GroupBox");
            LukaJuneLiteOneHalfLibrary.makeText(strUiAdviceForNewPpl, styDescription);
            EditorGUILayout.EndVertical();
            EditorGUILayout.Space();
        }

        // about me tab
        tabExtraAboutMe = LukaJuneLiteOneHalfLibrary.makeFoldout(tabExtraAboutMe, "About Me", 16);
        if (tabExtraAboutMe) {
            EditorGUILayout.BeginVertical("GroupBox");
            LukaJuneLiteOneHalfLibrary.makeText(strUiAboutMe, styDescription);
            EditorGUILayout.EndVertical();
            EditorGUILayout.Space();
        }

        // other ad
        LukaJuneLiteOneHalfLibrary.doNotifcation(boolUiMetaOtherAd, strUiMetaOtherAdTitle, strUiMetaOtherAdDescription, 12);

        LukaJuneLiteOneHalfLibrary.makeDivider();

        // <3
        LukaJuneLiteOneHalfLibrary.makeBanner("Images/JuneLiteBanner_JunePro");

        // what is pro
        tabProWhatIsPro = LukaJuneLiteOneHalfLibrary.makeFoldout(tabProWhatIsPro, "What is Pro?", 16);
        if (tabProWhatIsPro)
        {
            EditorGUILayout.BeginVertical("GroupBox");
            LukaJuneLiteOneHalfLibrary.makeText(strUiWhatIsPro, styDescription);
            EditorGUILayout.EndVertical();
            EditorGUILayout.Space();
        }

        // why pro
        /*tabProWhyPro = LukaJuneLiteOneHalfLibrary.makeFoldout(tabProWhyPro, "Why Pro?", 16);
        if (tabProWhyPro)
        {
            // not using as of now
        }*/
        ...
        // pro vs lite
        tabProComparison = LukaJuneLiteOneHalfLibrary.makeFoldout(tabProComparison, "Pro vs Lite", 16);
        if (tabProComparison) {
            EditorGUILayout.BeginVertical("GroupBox");
            LukaJuneLiteOneHalfLibrary.makeText(strUiProVsLite, styDescription);
            EditorGUILayout.EndVertical();
            EditorGUILayout.Space();
        }

        // pro features
        tabProFeatures = LukaJuneLiteOneHalfLibrary.makeFoldout(tabProFeatures, "Pro Features", 16);
        if (tabProFeatures) {
            EditorGUILayout.BeginVertical("GroupBox");
            LukaJuneLiteOneHalfLibrary.makeText(strUiProFeatures, styDescription);
            EditorGUILayout.EndVertical();
            EditorGUILayout.Space();
        }

        // pro vs competitors
        tabProCompetitors = LukaJuneLiteOneHalfLibrary.makeFoldout(tabProCompetitors, "Pro vs Competitors", 16);
        if (tabProCompetitors) {
            EditorGUILayout.BeginVertical("GroupBox");
            LukaJuneLiteOneHalfLibrary.makeText(strUiProVsCompetitor, styDescription);
            EditorGUILayout.EndVertical();
            EditorGUILayout.Space();
        }

        // where pro
        tabProWherePro = LukaJuneLiteOneHalfLibrary.makeFoldout(tabProWherePro, "Where can I get Pro?", 16);
        if (tabProWherePro)
        {
            EditorGUILayout.BeginVertical("GroupBox");
            LukaJuneLiteOneHalfLibrary.makeText(strUiWherePro, styDescription);
            EditorGUILayout.EndVertical();
            EditorGUILayout.Space();
        }

        // announcements
        LukaJuneLiteOneHalfLibrary.doNotifcation(boolUiMetaOtherMOTD, strUiMessageOfTheDayTitle, strUiMetaOtherMOTD, 12);

        // buttons
        EditorGUILayout.BeginHorizontal();
        if (GUILayout.Button(strUiButtonDiscordMe))
        {
            LukaJuneLiteOneHalfLibrary.makePopup("My Discord", "luka#8375");
        }
        if (GUILayout.Button(strUiButtonDiscordServer))
        {
            if (strPublicDiscord == "none")
            {
                LukaJuneLiteOneHalfLibrary.makePopup("Discord Server", "There is no Discord server at this time! If you have issues or suggestions, or want to commission, etc., please contact me directly at luka#8375 on Discord!");
            } else {
                bool didWork = LukaJuneLiteOneHalfLibrary.openWebpage(strPublicDiscord);
                if (!didWork)
                {
                    LukaJuneLiteOneHalfLibrary.makePopup("Discord Server", "There is no Discord server at this time! If you have issues or suggestions, or want to commission, etc., please contact me directly at luka#8375 on Discord!");
                }
        ...
        {
            bool didWork = LukaJuneLiteOneHalfLibrary.openWebpage("https://github.com/lukasong/");
            if (!didWork)
            {
                LukaJuneLiteOneHalfLibrary.makePopup("Github", "https://github.com/lukasong/");
            }
        }
        if (GUILayout.Button(strUiButtonYoutube))
        {
            bool didWork = LukaJuneLiteOneHalfLibrary.openWebpage("https://www.youtube.com/channel/UCwyJeuxwhgnxre3FaSacEug");
            if (!didWork)
            {
                LukaJuneLiteOneHalfLibrary.makePopup("Youtube", "https://www.youtube.com/channel/UCwyJeuxwhgnxre3FaSacEug");
            }
        }
        EditorGUILayout.EndHorizontal();
        EditorGUILayout.BeginHorizontal();
        ...
        {
            bool didWork = LukaJuneLiteOneHalfLibrary.openWebpage("https://app.gumroad.com/lukasong");
            if (!didWork)
            {
                LukaJuneLiteOneHalfLibrary.makePopup("Gumroad", "https://app.gumroad.com/lukasong");
            }
        }
        if (GUILayout.Button(strUiButtonBooth))
        {
            bool didWork = LukaJuneLiteOneHalfLibrary.openWebpage("https://lukasong.booth.pm/");
            if (!didWork)
            {
                LukaJuneLiteOneHalfLibrary.makePopup("Booth", "https://lukasong.booth.pm/");
            }
        }
        EditorGUILayout.EndHorizontal();
        if (GUILayout.Button(strUiButtonWebsite))
        {
            bool didWork = LukaJuneLiteOneHalfLibrary.openWebpage("https://www.luka.moe/june");
            if (!didWork)
            {
                LukaJuneLiteOneHalfLibrary.makePopup("Website", "https://www.luka.moe/june");
            }
        }
        ...
        // footer
        EditorGUILayout.Space();
        LukaJuneLiteOneHalfLibrary.makeText("june lite " + LukaJuneLiteOneHalfLibrary.getHeart() + " version one (rainbow road)", styFooter);
        LukaJuneLiteOneHalfLibrary.makeText(LukaJuneLiteOneHalfLibrary.getHeart() + " <b>assets protected under copyright</b> " + LukaJuneLiteOneHalfLibrary.getHeart(), styFooter);
