...
void effectDistortion(inout float2 inputUVs,
    ...
    float3 inputOverlayCoordinates) {
    // distortion effect
    [branch] if (inputStyle != 0) {
        [forcecase] switch (inputStyle) {
            case 2: // wavey
                ...
                break;
            case 3: // texture
                doDistortTexture(inputUVs, inputSpeedX, inputSpeedY, inputPowerX, inputPowerY, inputTexture, inputTextureScale, inputTexture_ST, inputOverlayCoordinates);
                break;
            default: // sincos
