...
Shader "luka/junelite/onehalf"
{
    Properties
    {
        ...
        [IntRange] _LiteUVManipulationGlitch ("UV Glitch", Range(0, 1)) = 0
        _LiteUVManipulationGlitchAmount ("UV Glitch Amount", Range(4, 0.1)) = 2
        // filters
        //[Space(30)]
        //[Header(FILTERS)]
        //[Header(0 is off 1 is on for all fx here)]
        ...
        [IntRange] _LiteFilterGlitch ("Color Glitch", Range(0, 1)) = 0
        _LiteFilterGlitchAmount ("Color Glitch Amount", Range(4, 0.1)) = 2
    ...
    SubShader
    {
		...
		//|				 lite pass					      |
		//|===============================================|
        GrabPass { "_LukaJuneLitePass" }
        Pass
        {
		    Name "LukaJuneLiteOnePass"
            ...
            #include "Resources/Code/Includes/LukaJuneLiteUniversal.cginc"
            #include "Resources/Code/Includes/LukaJuneLiteVertex.cginc"
            #include "Resources/Code/Includes/LukaJuneLitePixel.cginc"
            ENDCG
        }
    }
	...
	FallBack "Diffuse"
	CustomEditor "LukaJuneLiteUIOneHalf"
}
